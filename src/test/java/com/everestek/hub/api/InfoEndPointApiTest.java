...
class InfoEndPointApiTest {
    ...
    void testContributeSuccess() throws Exception {
        String manifestContent = """
                ...
                Implementation-Title: everestek-hub
        ...
        Assertions.assertEquals("everestek-hub", info.get("serviceName"), "Expected service name does not match.");
        Assertions.assertEquals(
                "The everestek-hub micro-service for EVERESTEK.",
